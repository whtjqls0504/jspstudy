 ...
 * 3. javax.sevlet.http.HttpServlet 클래스를 상속 받는다.
 * 4. jsp/servlet container에 저장되기 때문에 동일한 이름의 서블릿을 2개 이상 만들 수 없다.
 ...
 * 
 * 1. 형식
 *  protocol://host:post/contextPath/URLMapping
 * 2. contextPath
 *  1) 프로젝트가 실행될 때 가지는 기본 경로를 의미한다. (Context Root)
 *  2) 수정 방법
 *    (1) 프로젝트 속성(properties) - Web Project Setting
 *  3) URLMapping
 *    1) 서블릿의 실행 결로를 의미한다. (URL Pattern)
 *    2) 수정 방법
 *      (1) @WebServlet 애너테이션
