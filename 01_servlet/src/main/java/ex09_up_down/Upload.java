...
public class Upload extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
	   ...
	   *  3. zip 압축 해제 후 lib/cos.jar라이브러리 -> 프로젝트 webapp/WEB-INF/lib/cor.jar
	   */
	  
	  /*
	   * cos.jar
	   * 1. 업로드 전용 라이브러리이다.
	   * 2. 파일 첨부 폼 양식은 enctype="multipart/form"로 설정하는데 이렇게 되면 HttpServletRequest을 사용할 수 있다.
