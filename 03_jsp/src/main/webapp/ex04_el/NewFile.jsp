...
<body>
	...
	<%--
		...
		Jsp binding 영역(어떤 값을 속성(Attribute)의 형태로 저장할 때 사용하는 영역)
			...
			Jsp binding 영역에 저장된 속성은(Attribute)은 모두 표현언어(EL)로 표현할 수 있다.
	...
	<%--
		...
		3. 형식
			 ${값}
		4. Jsp 표현식 <%=값%>을 대체 할 수 있다. 
		5. binding 영역 내장 객체 
			 1) pageContex를 의미하는 pageScope 객체
